  ...
  return (
    <>
      ...
      <div className="header-note">
        ...
        <span className="note-close-btn" onClick={() => setIsNoteVisible(false)}>
            ...
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="header-top-link">
                  <Link href="/about.html" className="text-btn">
                    About Us
                  </Link>
                  <Link href="/register.html" className="text-btn">
                    My account
                  </Link>
                </div>
              </div>
              <div className="col-xl-6 col-lg-6 col-md-6">
                <div className="header-top-right">
                  <Link href="/contact.html" className="text-btn">
                    Track Order
                  </Link>
                ...
                <div className="header-main-content-wrapper">
                  <div className="header-main-left header-main-left-header1">
                    <div className="header-logo header1-logo">
                      <Link href="/index.html" className="logo-bl">
                        <img src="assets/img/logo/logo-bl-p.png" alt="logo-img" />
                      </Link>
                    </div>
                    <div className="main-menu main-menu2 hidden lg:block">
                      <nav id="mobile-menu">
                        <ul>
                          <li className="menu-item-has-children">
                            ...
                            <ul className="sub-menu">
                              <li><Link href="/index.html">Home Style 01 </Link></li>
                              <li><Link href="/index-2.html">Home Style 02 </Link></li>
                              <li><Link href="/index-3.html">Home Style 03 </Link></li>
                            </ul>
                          </li>
                          <li className="menu-item-has-children">
                            <Link href="/shop.html">
                            ...
                            <ul className="sub-menu">
                              <li className="menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                  <li><Link href="/shop-sidebar-5-column.html"> Shop Sidebar 5 Column </Link></li>
                                  <li><Link href="/shop-sidebar-4-column.html"> Shop Sidebar 4 Column </Link></li>
                                  <li><Link href="/shop-sidebar-3-column.html"> Shop Sidebar 3 Column </Link></li>
                                  <li><Link href="/shop-full-6-column.html"> Shop Full 6 Column </Link></li>
                                  <li><Link href="/shop-full-5-column.html"> Shop Full 5 Column </Link></li>
                                  <li><Link href="/shop-full-4-column.html"> Shop Full 4 Column </Link></li>
                                </ul>
                              </li>
                          ...
                          <li className="menu-item-has-children">
                            ...
                            <ul className="sub-menu">
                              ...
                              <li><Link href="/error-404.html"> 404 page </Link></li>
                            </ul>
                          </li>
                          <li className="menu-item-has-children">
                            <Link href="/blog.html">
                  ...
                  <div className="header-main-right header-main-right-header1">
                    <div className="action-list hidden xl:flex action-list-header2">
                      <div className="action-item action-item-cart">
                        <Link href="javascript:void(0)" className="view-cart-button"></Link>
                        <i className="fal fa-shopping-bag"></i>
                        <span className="action-item-number">3</span>

                        <Link href="#" className="cart-items-price" > $78.00 </Link>
                      </div>
                      <div className="action-item action-item-wishlist">
                        <Link href="javascript:void(0)" className="view-wishlist-button"></Link>
                    ...
                    <div className="menu-bar xl:hidden ml-20">
                      <Link className="side-toggle" href="javascript:void(0)"></Link>
            ...
            <div className="header-bottom-inner">
              <div className="category-menu pos-rel">
                ...
                <div className="category-items">
                  <Link href="/shop.html" className="category-item">
              ...
              <form action="#" className="filter-search-input header-search-2 hidden xl:inline-block">
